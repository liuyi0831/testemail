  ...
  <div class="nav-cent">
    ...
    <div class="sea">
      <div class="egc-sea-box">
        ...
        <input type="button" class="search-btn" value="搜索"> </div>
    </div>
...
<div class="car_feature">
  <div class="menucar">
    <div class="more" id="11"><a href="list.jsp">查看全部>></a></div>
    <ul>
      <li class="hover" id="tabs2_0" onmousemove="isShow4('tabs2_0','divs2_0','block','<a href=list.jsp>查看全部>></a>');">热卖好车</li>
      <li id="tabs2_1" onmousemove="isShow4('tabs2_1','divs2_1','block','<a href=list.jsp>查看全部>></a>');">最新上架</li>
      <li id="tabs2_2" onmousemove="isShow4('tabs2_2','divs2_2','block','<a href=list.jsp>查看全部>></a>');">降价急售</li>
      <li id="tabs2_3" onmousemove="isShow4('tabs2_3','divs2_3','block','<a href=list.jsp>查看全部>></a>');">准新车</li>
      <li id="tabs2_4" onmousemove="isShow4('tabs2_4','divs2_4','block','<a href=list.jsp>查看全部>></a>');">SUV</li>
    </ul>
  </div>
  <div class="clear_fix"></div>
      ...
      <div class="p-dl">
        <form class="registForm" onsubmit="return regcheck();" enctype="multipart/form-data" method="post" name="reg" id="reg">
          <ul class="login-items">
            <li class="clearfix">
              <input class="input" name="mobile" id="mobile" type="text" placeholder="手机号码（登录帐号）">
            </li>
            <li class="clearfix">
              <input class="input" name="userEmail" id="userEmail" type="text"placeholder="邮箱（获取验证码）">
            </li>
            <li class="clearfix">
              <input class="input left" type="text"   name="verify" placeholder="输入验证码" style="width:100px;" />
              <div id="send"><a href="#" class="send_code right" onclick="sendcode()" >获取验证码</a></div><input type="text" id="sendcode"/>
              <script type="text/javascript">
	function sendcode() {
		var email=document.getElementById("userEmail").value;
		var back=document.getElementById("sendcode");
			$.ajax({
				type:"get",
	...
	<ul>
		...
		<li>
			<a class="youhui">
				...
				<img src="images/foot03/zfew.jpg" width="196" height="205" class="hides" usemap="#takljsp"/>
			</a>
		</li>
	...
	$("#leftsead a").hover(function(){
		...
		if($(this).prop("className")=="youhui"){
			...
			$(this).children("img.hides").animate({marginRight:'-143px'},'slow',
					function(){$(this).hide();$(this).next("img.shows").show();});
		}
	});

	$("#top_btn").click(function(){if(scroll=="off") return;$("jsp,body").animate({scrollTop: 0}, 600);});
